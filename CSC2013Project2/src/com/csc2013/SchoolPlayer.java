...
public class SchoolPlayer
{
	...
	private static class MapPoint
	{
		 ...
		 * by 31 and xor-ing it with the y coordinate.
		 * 
	...
	private static class MapPath
	{
		...
		public int hashCode()
		{
			...
			if(length == 1)
				...
				return (this.superPath.hashCode() * 31) + getLastPoint()
						.hashCode();
			else
				return (getStepPath().hashCode() * 31) + getLastPoint()
						.hashCode();
		}
