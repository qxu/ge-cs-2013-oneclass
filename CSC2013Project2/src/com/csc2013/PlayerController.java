...
public class PlayerController {
	...
	public Action nextMove(final PlayerVision vision, final int keyCount,
		...
		if (keyCount > 0) {
			if (vision.CurrentPoint.South == BoxType.Door
					|| vision.CurrentPoint.North == BoxType.Door
					|| vision.CurrentPoint.East == BoxType.Door
					|| vision.CurrentPoint.West == BoxType.Door) {
				return Action.Use;
			}
		}
